...
public class MaksaOstoksetServlet extends WebKauppaServlet {
    ...
    public MaksaOstoksetServlet(Varasto varasto, TuoteDAO tuote, PankkiFasaadi pankki, ToimitusjarjestelmaFasaadi toimitusjarjestelma) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Suoritus ostos = suoritukset.OstoksenSuoritus(nimi, osoite, luottokorttinumero, ostoskori, varasto);

        request.setAttribute("osoite", osoite);
        request.setAttribute("hinta", ostoskori.hinta());

        if (((OstoksenSuoritus)ostos).suoritaOstos()) {
