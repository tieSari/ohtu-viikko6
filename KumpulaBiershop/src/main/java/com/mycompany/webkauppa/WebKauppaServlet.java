...
import com.mycompany.webkauppa.ohjaus.SuoritusTehdas;
...
public abstract class WebKauppaServlet extends HttpServlet {
    ...
    protected SuoritusTehdas suoritukset;
    protected TuoteDAO tuote;
    protected PankkiFasaadi pankki;
    protected ToimitusjarjestelmaFasaadi toimitusjarjestelma;

    public WebKauppaServlet(Varasto varasto, TuoteDAO tuote, PankkiFasaadi pankki, ToimitusjarjestelmaFasaadi toimitusjarjestelma) {
        this.varasto = varasto;
        this.pankki = pankki;
        this.tuote = tuote;
        this.toimitusjarjestelma = toimitusjarjestelma;
        
        suoritukset = new SuoritusTehdas();
    }        
